...
<span id="search" class="container-inline">
  <input class="search-input form-text" type="text" maxlength="128" name="search_theme_form" id="edit-search-theme-form-header"  size="15" value="City,hotel name,etc." onfocus="if (this.value == 'City,hotel name,etc.') {this.value = '';}" onblur="if (this.value == '') {this.value = 'City,hotel name,etc.';}" title="<?php print t('Enter search terms') ?>" />
