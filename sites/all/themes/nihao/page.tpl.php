  ...
  <div id="page" class="page">
    <div id="page-inner" class="page-inner">
      ...
      <div id="header-group-wrapper" class="header-group-wrapper full-width">
        <div id="header-group" class="header-group row <?php print $grid_width; ?>">
          <div id="header-group-inner" class="header-group-inner inner clearfix">
            ...
            Nihao Tours (China) offers tour packages, theme tours; city packages, Day tours designed for independent travelers, couples and families or groups. Specially Yangtze River cruises, China Hotels, domestic China airlines schedule and airfares.
            </div>
      ...
      <div id="main-wrapper" class="main-wrapper full-width">
        <div id="breadcrumbs-wrapper" class="breadcrumbs-wrapper row <?php print $grid_width; ?>">
      ...
      <div id="footer-message-wrapper" class="footer-message-wrapper full-width">
        <div id="footer-message" class="footer-message row <?php print $grid_width; ?>">
          <div id="footer-message-inner" class="footer-message-inner inner clearfix">
            <div id="footer-left" class="footer-left"><?php print $footer; ?></div>
