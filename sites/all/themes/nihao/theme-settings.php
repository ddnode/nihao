 ...
 */
function nihao_default_theme_settings() {
  $defaults = array(
 ...
 */
function nihao_initialize_theme_settings($theme_name) {
  ...
  if (!isset($theme_settings['primary_menu_dropdown']) || $theme_settings['rebuild_registry'] == 1) {
    ...
    $defaults = array_merge(nihao_default_theme_settings(), $info_theme_settings);
